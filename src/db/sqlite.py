...
class SQLite():
    ...
    def query(self, table_name:str, condition:str = "", is_contain_column_name:bool = False) -> tuple:
        ...
        Args:
            table_name (str): The name of table
            condition (str, optional): Conditions of query. Defaults to "". If you want to add condition, please add it like 'WHERE item1 = 2', must add 'WHERE'
    ...
    def update(self, table_name:str, column_value:dict, condition:str = ""):
        ...
        Args:
            ...
            condition (str, optional): Conditions of update. Defaults to "". If you want to add condition, please add it like 'WHERE item1 = 2', must add 'WHERE'.
        """
    ...
    def delete(self, table_name:str, condition:str = ""):
        ...
        Args:
            table_name (str): The name of table
            condition (str, optional): Conditions of delete. Defaults to "". If you want to add condition, please add it like 'WHERE item1 = 2', must add 'WHERE'.
        """
